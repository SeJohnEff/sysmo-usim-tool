    ...
    def read_card_data(self) -> Optional[Dict[str, any]]:
        ...
        try:
            ...
            try:
                ...
                print(f"DEBUG: ad_response type: {type(ad_response)}")
                print(f"DEBUG: ad_response value: {ad_response}")
                print(f"DEBUG: has .data attr: {hasattr(ad_response, 'data')}")
                if hasattr(ad_response, 'data'):
                    print(f"DEBUG: ad_response.data type: {type(ad_response.data)}")
                    print(f"DEBUG: ad_response.data value: {ad_response.data}")
                # Extract data from Card_res_apdu object
                ad_data = ad_response.data if hasattr(ad_response, 'data') else ad_response
                print(f"DEBUG: ad_data type after extraction: {type(ad_data)}")
